...
public class FailoverSystemTest {
    ...
    void testBackupDataConsistency() throws Exception {
        ...
        masterController = mainContainer.createNewAgent("GameMaster", "explodingkittens.remote.GameMasterAgent", new Object[]{"2"});
        backupController = mainContainer.createNewAgent("BackupMaster", "explodingkittens.remote.BackupMasterAgent", null);
        masterController.start();
        backupController.start();

        System.out.println("[TEST 1] Avvio giocatori...");
        AgentController p1 = mainContainer.createNewAgent("Player1", "explodingkittens.remote.PlayerAgent", new Object[]{"P1", 2});
        AgentController p2 = mainContainer.createNewAgent("Player2", "explodingkittens.remote.PlayerAgent", new Object[]{"P2", 2});
        p1.start();
        p2.start();
    ...
    void testCatCardConsistency() throws Exception {
        ...
        AgentController p1 = mainContainer.createNewAgent("Ladro", "explodingkittens.remote.PlayerAgent", new Object[]{"Ladro", 2});
        AgentController p2 = mainContainer.createNewAgent("Vittima", "explodingkittens.remote.PlayerAgent", new Object[]{"Vittima", 2});
        p1.start();
        p2.start();
